...
export const DevToIcon = ({ className, ...rest }) => (
  <svg xmlns="http://www.w3.org/2000/svg"
    ...
    <rect
      ...
      rx="15%"
      fill="#000000" stroke="white" strokeWidth="10" />
...
export const MediumIcon = ({ fill, className, ...rest }) => (
  <svg
      width="1em"
      height="1em"
  ...
  >
      <path
          fill={fill} // Use the fill prop passed from the parent
