  ...
  return (
    <footer className='w-full border-t-2 border-solid text-lg border-dark font-medium dark:border-light'>
        <Layout className='!py-6 flex items-center justify-between'>
            <span className='text-dark dark:text-light h-full w-full p-32 xl:p-24 lg:p-16 -z-1  md:p-12 sm:p-8 py-8 flex items-center justify-between lg:flex-col lg:py-6'>{new Date().getFullYear()} &copy; All Rights Reserved
